...
list_tweet = ["Tulus","Aceh","#TebakScorebarengOnix","#ShopeeKaraokeDapetMobil","#FIFAMobileIndonesia","#KemenanganBersama2024","#VaksinasiBooster",
	"#AturanAntiCintaJKT48","#IkatanCintaEp971","Mahasiswa"]
